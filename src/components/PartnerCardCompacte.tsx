 ...
 *
 * Elle reste plus legere que la grande carte — la photo est une vignette au
 * lieu d'occuper une demi-largeur, et il n'y a ni atouts ni description — mais
 * pas fade pour autant : filet rose, bouton circulaire et zoom au survol
 * reprennent le vocabulaire du reste du site. La hierarchie tient a la surface
 * occupee, pas a un manque de soin.
 *
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className="absolute inset-y-0 left-0 z-10 w-[3px] bg-[#FF0080] transition-all duration-300 group-hover:w-[7px] motion-reduce:transition-none"
          aria-hidden="true"
        />

        {/* Vignette a fleur de bord, sans marge : elle donne son assise a la
            carte. La largeur est fixe et la hauteur suit celle du bloc, d'ou
