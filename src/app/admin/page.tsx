    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {/* En premier : c'est la seule carte qui reclame une action, et un
              client attend au bout de chaque demande non traitee. */}
          <Link
            href="/admin/demandes"
          ...
          >
            ...
            <p className="text-gray-500 text-sm" style={{ fontFamily: "var(--font-cormorant)" }}>
              Demandes de cours et reservations click &amp; collect. Confirmer, reprogrammer ou annuler previent le client par courriel.
            </p>
          </Link>
